...
import { businessOutline, calendarOutline, call, constructOutline, mailOutline, personCircle, phonePortraitOutline, timeOutline } from 'ionicons/icons';
...
empleado: any = null; // Aquí guardaremos la respuesta de la API
  ...
  constructor(
    ...
    addIcons ({call,businessOutline,constructOutline,phonePortraitOutline,personCircle,mailOutline,calendarOutline,timeOutline})
  }

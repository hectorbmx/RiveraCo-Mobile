...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, ProfileMenuComponent, CommonModule,IonProgressBar, FormsModule,IonSpinner,IonIcon,RouterModule]
})
...
console.log('empleadosPreview', this.empleadosPreview);
        this.loading = false;
      },
      error: (err) => {
